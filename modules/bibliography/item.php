 ...
 * Foundation, Inc., 51 Franklin Street, Fifth Flosor, Boston, MA  02110-1301  USA
 *
 */
...
if (isset($_POST['saveData']) and $can_read and $can_write) {
    ...
    if (empty($itemCode)) {
        ...
        $dataItemMaterial['property_stamp'] = NULL; 
        $dataItemMaterial['inventory_stamp'] = NULL; 
        $dataItemMaterial['barcode'] =  NULL; 
        $dataItemMaterial['book_pocket'] = NULL; 
        $dataItemMaterial['book_card'] = NULL; 
        $dataItemMaterial['catalog_card'] = NULL; 
        $dataItemMaterial['book_label'] = NULL; 
        $dataItemMaterial['date_due_slip'] = NULL; 

        if(isset($_POST['itemMaterial'])){
            if(isset($_POST['itemMaterial'][0])){ 
                if($_POST['itemMaterial'][0] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][0] == 2){ 
                   $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][0] == 3){ 
                   $dataItemMaterial['barcode'] = 3; 
                }
                if($_POST['itemMaterial'][0] == 4){ 
                   $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][0] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][0] == 6){ 
                   $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][0] == 7){    
                   $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][0] == 8){ 
                  $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][1])){ 
                if($_POST['itemMaterial'][1] == 1){ 
                     $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][1] == 2){ 
                    $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][1] == 3){ 
                    $dataItemMaterial['barcode'] = 3; 
                }
                if($_POST['itemMaterial'][1] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][1] == 5){ 
                     $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][1] == 6){ 
                    $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][1] == 7){ 
                   $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][1] == 8){ 
                   $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][2])){ 
                if($_POST['itemMaterial'][2] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][2] == 2){ 
                   $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][2] == 3){ 
                   $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][2] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][2] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][2] == 6){ 
                    $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][2] == 7){ 
                   $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][2] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][3])){ 
                if($_POST['itemMaterial'][3] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][3] == 2){ 
                    $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][3] == 3){ 
                    $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][3] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][3] == 5){ 
                     $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][3] == 6){ 
                   $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][3] == 7){ 
                     $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][3] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][4])){ 
                if($_POST['itemMaterial'][4] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][4] == 2){ 
                     $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][4] == 3){ 
                   $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][4] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][4] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][4] == 6){ 
                     $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][4] == 7){ 
                     $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][4] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][5])){ 
                if($_POST['itemMaterial'][5] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][5] == 2){ 
                     $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][5] == 3){ 
                   $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][5] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][5] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][5] == 6){ 
                     $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][5] == 7){ 
                     $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][5] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][6])){ 
                if($_POST['itemMaterial'][6] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][6] == 2){ 
                     $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][6] == 3){ 
                   $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][6] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][6] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][6] == 6){ 
                     $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][6] == 7){ 
                     $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][6] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
            if(isset($_POST['itemMaterial'][7])){ 
                if($_POST['itemMaterial'][7] == 1){ 
                   $dataItemMaterial['property_stamp'] = 1;
                }
                if($_POST['itemMaterial'][7] == 2){ 
                     $dataItemMaterial['inventory_stamp'] = 2;
                }
                if($_POST['itemMaterial'][7] == 3){ 
                   $dataItemMaterial['barcode'] = 3;
                }
                if($_POST['itemMaterial'][7] == 4){ 
                    $dataItemMaterial['book_pocket'] = 4;
                }
                if($_POST['itemMaterial'][7] == 5){ 
                   $dataItemMaterial['book_card'] = 5;
                }
                if($_POST['itemMaterial'][7] == 6){ 
                     $dataItemMaterial['catalog_card'] = 6;
                }
                if($_POST['itemMaterial'][7] == 7){ 
                     $dataItemMaterial['book_label'] = 7;
                }
                if($_POST['itemMaterial'][7] == 8){ 
                    $dataItemMaterial['date_due_slip'] = 8;
                }
            }
        }
        ...
        if (isset($_POST['updateRecordID'])) {
            ...
            $updateRecordMaterialID = isset($_POST['updateRecordMaterialID']) ? intval($_POST['updateRecordMaterialID']) : 0;
            ...
            if($updateRecordMaterialID <= 0){
                ...
                $data['item_material_id'] = $sql_op->insert_id;
                 ...
                 if ($insertItemMaterials) {
                        utility::jsToastr('Item Material', __('Item Material Data Successfully Inserted'), 'success');
                 }else{ 
                        utility::jsToastr('Item Material', __('Item Material Data FAILED to Insert. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
                 }
            } 
            ...
            if($updateRecordMaterialID > 0) {
                ...
                if($check_null_q->num_rows >= 1){
                    $deleteItemMaterial = $sql_op->delete('item_materials', "id=$updateRecordMaterialID");
                    if ($deleteItemMaterial) {
                        utility::jsToastr('Item Material', __('Item Material Data Successfully Deleted'), 'success');
                    }else{ 
                        utility::jsToastr('Item Material', __('Item Material Data FAILED to Delete. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
                    }
                    ...
                    if ($updateIdItemMaterial) {
                        utility::jsToastr('Item', __('Item Data ID Item Material Successfully Updated'), 'success');
                    }else{ 
                        utility::jsToastr('Item', __('Item Data ID Item Material FAILED to Save. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
                    }
                }

                if ($updateItemMaterials) {
                    // write log
                    writeLog('staff', $_SESSION['uid'], 'bibliography', $_SESSION['realname'] . ' update item data (' . $data['item_code'] . ') with title (' . $title . ')', 'Item Material', 'Update');
                    if ($sysconf['bibliography_item_update_notification']) {
                        utility::jsToastr('Item', __('Item Material Data Successfully Updated'), 'success');
                    }
                    if ($in_pop_up) {
                    ...
                    utility::jsToastr('Item', __('Item Material Data FAILED to Save. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
                }
                //exit();
            }


            $updateRecordConditionID = isset($_POST['updateRecordConditionID']) ? intval($_POST['updateRecordConditionID']) : 0;
            ...
            if($updateRecordConditionID <= 0){
               ...
               if ($insertItemConditions) {
                utility::jsToastr('Item Condition', __('Item Condition Data Successfully Inserted'), 'success');
               }else{ 
                utility::jsToastr('Item Condition', __('Item Condition Data FAILED to Insert. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
               }
            }
            ...
            if($updateRecordConditionID > 0) {
                ...
                if ($updateItemConditions) {
                 utility::jsToastr('Item Condition', __('Item Condition Data Successfully Updated'), 'success');
                }else{ 
                 utility::jsToastr('Item Condition', __('Item Condition Data FAILED to Update. Please Contact System Administrator') . "\nDEBUG : " . $sql_op->error, 'error');
                }
            }
    ...
    foreach ($_POST['itemID'] as $itemID) {
        ...
        $loan_q = $dbs->query('SELECT i.item_code, i.item_condition_id, i.item_material_id, b.title, COUNT(l.loan_id) FROM item AS i
        ...
        // if there is no loan
        if ($loan_d[4] < 1) {
            if (!$sql_op->delete('item_conditions', 'id='.$loan_d[1])) {
                $error_num++;
            } else {
                // write log
                utility::writeLogs($dbs, 'staff', $_SESSION['uid'], 'bibliography', $_SESSION['realname'].' DELETE item data ('.$loan_d[0].') with title ('.$loan_d[3].')', 'Item', 'Delete');
            }

            if (!$sql_op->delete('item_materials', 'id='.$loan_d[2])) {
                $error_num++;
            } else {
                // write log
                utility::writeLogs($dbs, 'staff', $_SESSION['uid'], 'bibliography', $_SESSION['realname'].' DELETE item data ('.$loan_d[0].') with title ('.$loan_d[3].')', 'Item', 'Delete');
            ...
            if (!$sql_op->delete('item', 'item_id=' . $itemID)) {
                ...
                // write log
                writeLog('staff', $_SESSION['uid'], 'bibliography', $_SESSION['realname'] . ' DELETE item data (' . $loan_d[0] . ') with title (' . $loan_d[3] . ')', 'Item', 'Delete');
            }
        } else {
            $still_on_loan[] = $loan_d[0] . ' - ' . $loan_d[3];
            $error_num++;
        }
    }
...
if (isset($_POST['detail']) or (isset($_GET['action']) and $_GET['action'] == 'detail')) {
    ...
    if ($rec_q->num_rows > 0) {
        ...
        if (!$in_pop_up) {
            ...
            $itemMaterialId = $rec_d['item_material_id'] ??= 0;
            $itemConditionId = $rec_d['item_condition_id'] ??= 0;
            $form->addHidden('updateRecordMaterialID', intval($itemMaterialId));
            $form->addHidden('updateRecordConditionID', intval($itemConditionId));
        }
        // form record title
    ...
    if(isset($item_material_d)){
       
        $item_material_val[0] = (integer)$item_material_d['property_stamp'];
        $item_material_val[1] = (integer)$item_material_d['inventory_stamp'];
        $item_material_val[2] = (integer)$item_material_d['barcode'];
        $item_material_val[3] = (integer)$item_material_d['book_pocket'];
        $item_material_val[4] = (integer)$item_material_d['book_card'];
        $item_material_val[5] = (integer)$item_material_d['catalog_card'];
        $item_material_val[6] = (integer)$item_material_d['book_label'];
        $item_material_val[7] = (integer)$item_material_d['date_due_slip'];                          
    }
    
    
    $item_material->element_value= $item_material_val;
    //$item_material->element_options= $item_material_val;
    ...
    $physicalc_options[] = array('2', __('Rusak Ringan'));
    $physicalc_options[] = array('3', __('Rusak Berat'));
    $item_condition_q = $dbs->query('SELECT physical_condition, physical_condition_info FROM item_conditions WHERE id='.(integer)$rec_d['item_condition_id']);
    $item_condition_d = $item_condition_q->fetch_array();
    $form->addRadio('physicalCondition', __('Physical Condition'), $physicalc_options, empty($item_condition_d['physical_condition'])?'1':$item_condition_d['physical_condition']);
    $form->addTextField('textarea', 'physicalConditioninfo', __('Physical Condition Info'), $item_condition_d['physical_condition_info']??'', 'style="width: 40%;" class="form-control"');
