<?php
/**
 * Plugin Name: Pemustaka Untuk SLiMS
 * Plugin URI: -
 * Description: Plugins pemustaka dan laporan pemustaka untuk SLIMS
 * Version: 1.0.0
 * Author: -
 * Author URI: -
 */
...
Plugins::group('Pemustaka', function() use($pathKelengkapanBahanPustaka, $pathRekapitulasiKelengkapanBahanPustaka) {
