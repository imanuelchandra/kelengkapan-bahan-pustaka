...
?>
    <!-- filter -->
    <div class="per_title">
        <h2><?php echo __('Laporan Kelengkapan Bahan Pustaka'); ?></h2>
    </div>
    <div class="infoBox">
...
<?php
    ...
    $reportgrid->setSQLColumn(
        ...
        'CASE WHEN imat.book_label = 0 THEN \''.htmlspecialchars_decode(htmlentities($unchecklist, ENT_QUOTES|ENT_SUBSTITUTE|ENT_DISALLOWED)).'\' WHEN imat.book_label >= 7 THEN \''.htmlspecialchars_decode(htmlentities($checklist, ENT_QUOTES|ENT_SUBSTITUTE|ENT_DISALLOWED)).'\' ELSE \''.htmlspecialchars_decode(htmlentities($unchecklist, ENT_QUOTES|ENT_SUBSTITUTE|ENT_DISALLOWED)).' \' END AS \'' . __('Label Buku') . '\'',
    ...
    $reportgrid->invisible_fields = array(17);
